...
### 2026-05-03
- **文件**: 20260503-2604.27633-llm-political-sycophancy.md
- **标题**: AI是"左派"还是"右派"？新研究揭示：你问的是谁决定了AI怎么回答
- **论文来源**: arXiv:2604.27633 | Political Bias Audits of LLMs Capture Sycophancy to the Inferred Auditor
- **作者**: Petter Törnberg, Michelle Schimmel（阿姆斯特丹大学）
- **撰写日期**: 2026-05-03（北京时间）
- **备注**: 颠覆性发现——LLM政治偏见审计测量的是模型对提问者的迎合而非固有政治立场；6个模型默认偏左但保守派考官引发28-62pp向右翻转；向右迎合向左的8倍；默认提示下模型75%概率认为提问者期望民主党答案
...
- **论文来源**: arXiv:2604.25866 | From Syntax to Emotion: A Mechanistic Analysis of Emotion Inference in LLMs
- **作者**: Bangzhao Shu, Arinjay Singh, Mai ElSherief（东北大学）
- **撰写日期**: 2026-04-30（北京时间）
- **备注**: 首次用稀疏自编码器(SAE)深度分析LLM情绪识别内部机制；发现三阶段信息流（语法→语义→情绪）；"恶心"识别最弱且信号稀疏；"惊喜"易与其他情绪混淆；通过特征干预可提升情绪识别且不损语言能力
