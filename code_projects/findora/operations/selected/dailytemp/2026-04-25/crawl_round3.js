...
const TODAY_SELECTIONS = {
  temu:       { catId: 1464,        catName: "宠物用品" },
  shein:      { catId: 3637,        catName: "箱包和行李箱" },
  amazon:     { catId: 15684181,    catName: "汽车" },
  sumaitong:  { catId: 13,          catName: "家装（硬装）" },
  tiktok:     { catId: 604453,      catName: "Furniture" }
};
...
const RAW_FILE = path.join(OUTPUT_DIR, 'raw_products_round3.json');
...
async function crawlAll() {
  ...
  console.log('选品采集任务 - 2026-04-25 第三轮');
