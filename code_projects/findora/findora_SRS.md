...
> **版本：** v3.33（SRS自动审查任务首次执行；同步system_design.md至v1.1.0）
> **最后更新：** 2026-04-13
...
| 2026-04-13 | v3.32：重排Section 3.1子章节编号（3.1.4~3.1.10规范化）；增加端点数量汇总表（6类29端点）；更新架构一致性检查清单版本号 |
...
| 公共端点 | F-040-01~05 | 5 |
| 用户端点 | F-040-06~13 | 8 |
| 内部管理端点 | F-040-14~18 | 5 |
| 全局配置端点 | F-040-24~26 | 3 |
| 身份认证端点 | F-040-27~30 | 4 |
| 外部系统接口 | F-040-20~23 | 4 |
| **合计** | | **29** |

> **统计口径说明**：
> - 站内API（公共+用户+管理+配置+认证）共 **25** 个端点
> - 包含外部系统集成接口（F-040-20~23）共 **29** 条接口定义
> - F-040-19 为预留编号，暂未启用
...
| 3 | AI Agent原生友好 | Section 3.1.6 Content Negotiation | ✅ |
