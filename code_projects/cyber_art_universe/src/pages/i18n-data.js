...
var I18N = {
  ...
  kb: {
    ...
    add_first_hint:  { zh: '请点击上方 Pipeline 栏右侧「选择卡片」按钮创建第一张卡片', en: 'Click "Select card" in the Pipeline bar to create the first card' },
  ...
  label: {
    ...
    select_card:      { zh: '选择卡片...', en: 'Select card...' },
